...
export function HomeDashboard({ language }: { language: string }) {
  ...
  const playWelcomeAudio = () => {
    const welcomeText = language === 'English' 
      ...
      : language === 'Malayalam'
      ? "Holy AI അനുഭവത്തിലേക്ക് സ്വാഗതം. ഈ വെബ്സൈറ്റ് വഴി നിങ്ങൾക്ക് ബൈബിൾ കൂടുതൽ വ്യക്തമായി പഠിക്കാം. ഓരോ ഭാഗവും എങ്ങനെ പ്രവർത്തിക്കുന്നു എന്ന് താഴെ പറയുന്നു: ഒന്നാമതായി, സ്റ്റോറി ബൈബിൾ. ഇവിടെ നിങ്ങൾക്ക് പഴയ നിയമത്തിൽ നിന്നോ പുതിയ നിയമത്തിൽ നിന്നോ പുസ്തകവും അധ്യായവും തിരഞ്ഞെടുക്കാം. ആ വചനത്തിന്റെ ചരിത്ര പശ്ചാത്തലവും കഥയും നിങ്ങൾക്ക് ലഭിക്കും. രണ്ടാമതായി, ബിബ്ലിക്കൽ സൊല്യൂഷൻസ്. നിങ്ങൾക്ക് ദുഃഖമോ ഉത്കണ്ഠയോ നേരിടുമ്പോൾ നിങ്ങളുടെ പ്രശ്നം ടൈപ്പ് ചെയ്യുക. ആശ്വാസം നൽകുന്ന ബൈബിൾ വചനങ്ങളും വിശദീകരണവും ലഭിക്കും. മൂന്നാമതായി, ജേർണി ടൈംലൈൻ. ബൈബിളിലെ പ്രധാന യാത്രകൾ ഭൂപടത്തിൽ കാണാം. താഴെയുള്ള ഓപ്ഷനുകളിൽ നിന്ന് തിരഞ്ഞെടുത്ത് ഉപയോഗിച്ച് തുടങ്ങുക."
      : "Willkommen beim Holy AI Erlebnis. Hier ist eine Schritt-für-Schritt-Anleitung: Erstens, die Story-Bibel. Hier können Sie jedes Buch, Kapitel und jeden Vers aus dem Alten oder Neuen Testament auswählen. Wir liefern den Vers mit einer Geschichte, die den historischen Kontext erklärt. Zweitens, Biblische Lösungen. Wenn Sie vor einer Herausforderung wie Angst oder Trauer stehen, geben Sie einfach Ihr Gefühl ein. Wir bieten tröstende Bibelverse und eine mitfühlende Erklärung. Drittens, die Reise-Timeline. Sie können epische biblische Reisen auf einer interaktiven Karte verfolgen. Wählen Sie unten eine Option, um zu beginnen.";
